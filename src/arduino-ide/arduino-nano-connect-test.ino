...
const char* SSID = "";
const char* PW = "";
const char* PUB_TOPIC = "arduino-nano-connect/test";
const unsigned long PUB_INTERVAL = 10 * 1000; // In milliseconds
...
const String CLIENT_ID = "arduino-nano-connect" + String(random(0xffff), HEX);
const char* BOARD_TYPE = "arduino-nano-connect";
